                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <a href="{{ route('admin.tags.edit', $tag->id) }}" wire:navigate class="font-medium text-blue-600 hover:underline">{{ __('Edit') }}</a>
                                    <form action="{{ route('admin.tags.destroy', $tag->id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure?') }}');">
                                        @csrf
                                        @method('DELETE')
